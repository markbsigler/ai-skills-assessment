...
This assessment measures AI skills across **ten dimensions** on a 0–9 scale:
...
| 3 | **AI-Assisted Testing & Quality Assurance** | Using AI to design, generate, and maintain tests and improve software quality |
| 4 | **AI-Assisted Design & Technical Communication** | Using AI for architecture, design decisions, planning, and technical writing |
| 5 | **Debugging & Root Cause Analysis** | Diagnosing and resolving defects and performance issues with AI |
| 6 | **AI Tool Fluency** | Practical experience with AI tooling, MCP, Agent Skills, and integrations |
| 7 | **AI Automation & Agents** | Designing and orchestrating AI agents for multi-step workflows |
| 8 | **Knowledge Engineering & RAG** | Curating, retrieving, and grounding AI outputs in authoritative sources |
| 9 | **AI Safety, Ethics & Risk Management** | Applying AI responsibly — including knowing when not to use it |
| 10 | **Collaborative AI Practices & Team Multiplier** | Amplifying AI capabilities across your team and organization |
...
5. Optionally, have a manager or tech lead complete the reviewer notes section.
